...
public class LastReadContentProvider extends ContentProvider {
  ...
  public Cursor query(Uri uri, String[] projection, String selection,
    ...
    Cursor cursor = db.query(LastReadDBHelper.TABLE, projection, selection,
  ...
  public Uri insert(Uri uri, ContentValues values) {
    ...
    db = dbHelper.getWritableDatabase();
    long rowId = db.insertWithOnConflict(LastReadDBHelper.TABLE, null, values,
  ...
  public int update(Uri uri, ContentValues values, String selection,
    ...
    db = dbHelper.getWritableDatabase();
    int count = db.update(LastReadDBHelper.TABLE, values, selection,
                          selectionArgs);
    getContext().getContentResolver().notifyChange(uri, null);
    return count;
  }
