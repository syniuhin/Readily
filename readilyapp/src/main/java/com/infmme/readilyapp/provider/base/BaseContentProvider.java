...
public abstract class BaseContentProvider extends ContentProvider {
  ...
  protected abstract QueryParams getQueryParams(Uri uri, String selection,
                                                String[] projection);
  ...
  public final boolean onCreate() {
    if (hasDebug()) {
      ...
      try {
        Class<?> sqliteDebugClass = Class.forName(
        ...
        if (hasDebug()) Log.w(getClass().getSimpleName(),
                              "Could not enable SQLiteDebug logging", t);
      }
    }
  ...
  public Uri insert(Uri uri, ContentValues values) {
    ...
    long rowId = mSqLiteOpenHelper.getWritableDatabase()
                                  .insertOrThrow(table, null, values);
    if (rowId == -1) return null;
    String notify;
    if (((notify = uri.getQueryParameter(
  ...
  public int update(Uri uri, ContentValues values, String selection,
    ...
    int res = mSqLiteOpenHelper.getWritableDatabase()
                               .update(queryParams.table, values,
  ...
  public int delete(Uri uri, String selection, String[] selectionArgs) {
    QueryParams queryParams = getQueryParams(uri, selection, null);
    int res = mSqLiteOpenHelper.getWritableDatabase()
                               .delete(queryParams.table, queryParams.selection,
                                       selectionArgs);
    String notify;
    if (res != 0 && ((notify = uri.getQueryParameter(
        QUERY_NOTIFY)) == null || "true".equals(notify))) {
  ...
  public Cursor query(Uri uri, String[] projection, String selection,
    ...
    projection = ensureIdIsFullyQualified(projection, queryParams.table,
                                          queryParams.idColumn);
    Cursor res = mSqLiteOpenHelper.getReadableDatabase()
                                  .query(queryParams.tablesWithJoins,
                                         projection, queryParams.selection,
                                         selectionArgs, groupBy,
                                         having,
                                         sortOrder == null ? queryParams
                                             .orderBy : sortOrder,
                                         limit);
  ...
  private String[] ensureIdIsFullyQualified(String[] projection,
  ...
  public ContentProviderResult[] applyBatch(
    ...
    try {
      ...
      ContentProviderResult[] results = new
