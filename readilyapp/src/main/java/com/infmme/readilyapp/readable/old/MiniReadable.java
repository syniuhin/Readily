...
public class MiniReadable extends Readable {
  ...
  public static Intent createDBServiceIntent(Context context,
                                             MiniReadable readable) {
    ...
    intent.putExtra(Constants.EXTRA_PERCENT,
                    readable.getPercent()); //dirty, dirty hack..
    return intent;
  }
