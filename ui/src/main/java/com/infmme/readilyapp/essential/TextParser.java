...
public class TextParser implements Serializable, Callable<TextParser> {
  ...
  static {
    ...
    final int[] englishPriorities =
        { 10, 4, 4, 4, 9, 12, 10, 12, 8, 10, 8, 6, 6, 5, 8, 6, 12, 5, 15, 12, 14, 12, 14, 13, 14,
            12 };
    int i = 0;
    ...
    final int[] russianPriorities =
        { 10, 4, 4, 7, 4, 7, 14, 9, 9, 6, 7, 5, 4, 4, 4, 10, 8, 10, 12, 5, 9, 15, 14, 14, 13, 10,
            10, 0, 10, 0,
            10, 12, 11 };
    i = 0;
  ...
  protected void buildEmphasis(Readable readable) {
    ...
    for (String word : readable.getWordList()) {
      ...
      Map<String, Pair<Integer, Integer>> priorities = new HashMap<String, Pair<Integer,
          Integer>>();
      int len = word.length();
